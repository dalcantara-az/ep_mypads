...
*  ## Description
*
*  This module regroups all Monitored pads from a logged users : groups, pads and,
*  _soon_, other users.
*/
...
module.exports = (function () {
    ...
    */
    ...
    mpad.controller = function () {
      if (!auth.isAuthenticated()) {
        conf.unauthUrl(true);
        return m.route('/login');
      }
      document.title = "Monitored Pads" + ' - ' + conf.SERVER.title;
  
      var c = {};

      form.initFields(c, ['url']);
